...
async function handle(req: NextRequest) {
  ...
  try {
    ...
    const edgeTool = new EdgeTool(apiKey, baseUrl, model, embeddings);
    const edgeTools = await edgeTool.getCustomTools();

    const agentApi = new AgentApi();
    const response = await agentApi.getApiHandler(req, reqBody, edgeTools);
